    ...
    return (
      <div className='container p-0 mt-10 border-l border-r border-b rounded grid grid-cols-3'>
        ...
        <div className='border-l border-t p-6 flex flex-col'>
            <button onClick={handlePayClick} className="bg-blue-300 border-black text-white hover:bg-blue-200 font-bold rounded shadow-[0.25rem_0.25rem_0px_0px_rgba(0.0.0.1)] focus-outline:none border-gray-900 hover:border-black border-2">Buy now!</button>
        </div>
      </div>
    );
  }
